...
namespace JCAT {
    std::vector<VkVertexInputBindingDescription> JCATModel2D::Vertex::getBindingDescriptions() {
        ...
        spriteBindingDescriptions[0].stride = sizeof(Vertex);
    ...
    std::vector<VkVertexInputAttributeDescription> JCATModel2D::Vertex::getAttributeDescriptions() {
        ...
        spriteAttributeDescriptions[0].offset = offsetof(Vertex, position);
        ...
        spriteAttributeDescriptions[1].offset = offsetof(Vertex, color);
